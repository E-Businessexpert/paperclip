...
export type {
  ...
  AgentDetail,
  AgentPermissions,
  DiscoveredServiceKind,
  DiscoveredServiceHostKind,
  DiscoveredServiceLifecycleState,
  DiscoveredSoftwareAssignmentKind,
...
export {
  ...
  updateAgentSchema,
  discoveredServiceKindSchema,
  discoveredServiceHostKindSchema,
  discoveredServiceLifecycleStateSchema,
  discoveredSoftwareAssignmentKindSchema,
  discoveredSoftwareAssignmentSchema,
