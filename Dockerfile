...
COPY packages/plugins/paperclip-plugin-dual-memory/package.json packages/plugins/paperclip-plugin-dual-memory/
...
RUN pnpm --filter @paperclipai/plugin-dual-memory build
